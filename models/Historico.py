...
historico_fields = {
    'historico_id': flaskFields.Integer,
...
class Historico(db.Model):
    ...
    historico_id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    reserva_id: Mapped[int] = mapped_column(Integer, nullable=False)
    sala_id: Mapped[int] = mapped_column(Integer, nullable=False)
    responsavel_id: Mapped[int] = mapped_column(Integer, nullable=False)
...
class HistoricoSchema(Schema):
    historico_id = fields.Int(dump_only=True)
